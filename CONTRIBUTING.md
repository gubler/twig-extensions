...
Contributions are welcome. We accept pull requests on [GitHub](https://github.com/gubler/twig-extensions).
...
* GitHub Issues: <https://github.com/gubler/twig-extensions/issues>
* Wiki: <https://github.com/gubler/twig-extensions/wiki>

## Reporting Bugs

Bugs are tracked in our project's [issue tracker](https://github.com/gubler/twig-extensions/issues).
...
If you have an idea for a new feature, it's a good idea to check out our [issues](https://github.com/gubler/twig-extensions/issues) or active [pull requests](https://github.com/gubler/twig-extensions/pulls) first to see if the feature is already being worked on. If not, feel free to submit an issue first, asking whether the feature is beneficial to the project. This will save you from doing a lot of development work only to have your feature rejected. We don't enjoy rejecting your hard work, but some features just don't fit with the goals of the project.
